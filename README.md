...
- Real time data or historical data? Realtime data would be costly depending how much data but I presume if we track the user data on real time then it would be very expensive. Therefore we need to understand what value this will bring for the growth of organisation. 
